...
//  System.setProperty("DATABASE_PASSWORD", dotenv["DATABASE_PASSWORD"] ?: "")
  ...
  val jwtSecret =
    System.getenv("JWT_SECRET") ?: dotenv["JWT_SECRET"]
      ?: environment.config.property("jwt.secret").getString()
  val jwtIssuer =
    System.getenv("JWT_ISSUER") ?: dotenv["JWT_ISSUER"]
      ?: environment.config.property("jwt.issuer").getString()
  val jwtAudience =
    System.getenv("JWT_AUDIENCE") ?: dotenv["JWT_AUDIENCE"]
      ?: environment.config.property("jwt.audience").getString()
  val uploadDir =
    System.getenv("UPLOAD_DIR") ?: dotenv["UPLOAD_DIR"]
...
fun AuthenticationConfig.apiKeyAuth(
  name: String,
  validate: suspend (String) -> Principal?,
) {
  register(
    object : AuthenticationProvider(object : Config(name) {}) {
